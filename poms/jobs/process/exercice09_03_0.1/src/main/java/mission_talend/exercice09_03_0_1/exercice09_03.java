...
package mission_talend.exercice09_03_0_1;
...
/**
 * Job: exercice09_03 Purpose: Préparation des tables pour le log catch<br>
 * Description: <br>
 * 
 ...
 * @status TEST
 */
public class exercice09_03 implements TalendJob {
	...
	private final String jobName = "exercice09_03";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					exercice09_03.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(exercice09_03.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:lqW8BKjY26FigWkpCYDYQHVCT2lDjhulveEczQl0QlXNxXKMxrB5");
	...
	public void tCreateTable_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					String tableName_tCreateTable_3 = "flowmeter";
					...
					java.sql.ResultSet rsTable_tCreateTable_3 = dbMetaData_tCreateTable_3.getTables("hr", null, null,
							new String[] { "TABLE" });
					while (rsTable_tCreateTable_3.next()) {
						String table_tCreateTable_3 = rsTable_tCreateTable_3.getString("TABLE_NAME");
						if (table_tCreateTable_3.equalsIgnoreCase("flowmeter")) {
	...
	public static void main(String[] args) {
		final exercice09_03 exercice09_03Class = new exercice09_03();

		int exitCode = exercice09_03Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice09_03.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice09_03_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = exercice09_03.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : exercice09_03");
		}
...
/************************************************************************************************
 * 34749 characters generated by Talend Open Studio for Data Integration on the
 * 11 février 2023 à 11:44:38 GMT+01:00
 ************************************************************************************************/