...
package mission_talend.exercice01_01_v2_0_1;
...
/**
 * Job: exercice01_01_V2 Purpose: Génération des fichiers CSV<br>
 ...
 * @status TEST
 */
public class exercice01_01_V2 implements TalendJob {
	...
	private final String jobName = "exercice01_01_V2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					exercice01_01_V2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(exercice01_01_V2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MISSION_TALEND_exercice01_01_V2 = new byte[0];
		static byte[] commonByteArray_MISSION_TALEND_exercice01_01_V2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MISSION_TALEND_exercice01_01_V2.length) {
					if (length < 1024 && commonByteArray_MISSION_TALEND_exercice01_01_V2.length == 0) {
						commonByteArray_MISSION_TALEND_exercice01_01_V2 = new byte[1024];
					} else {
						commonByteArray_MISSION_TALEND_exercice01_01_V2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MISSION_TALEND_exercice01_01_V2, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice01_01_V2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MISSION_TALEND_exercice01_01_V2, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice01_01_V2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MISSION_TALEND_exercice01_01_V2) {
...
// Start of branch "row3"
							if (row3 != null) {
								...
								ope_tFilterRow_1.matches(
										(row3.datedenaissance == null ? false
												: row3.datedenaissance
														.compareTo(TalendDate.parseDate("yyyy", "1986")) < 0),
										"datedenaissance.compareTo(TalendDate.parseDate(\"yyyy\",\"1986\")) < 0 failed");
								...
								if (ope_tFilterRow_1.getMatchFlag()) {
									...
									row4.datedenaissance = row3.datedenaissance;
									row4.salairedemande = row3.salairedemande;
									row4.numTel = row3.numTel;
...
///////////////////////		
									...
									if (row4.nom != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row4.nom));
									...
									if (row4.prenom != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row4.prenom));

									} //

									strBuffer_tLogRow_1.append("|");

									if (row4.datedenaissance != null) { //

										strBuffer_tLogRow_1
												.append(FormatterUtils.format_Date(row4.datedenaissance, "dd-MM-yyyy"));

									} //

									strBuffer_tLogRow_1.append("|");

									if (row4.salairedemande != null) { //

										strBuffer_tLogRow_1.append(String.valueOf(row4.salairedemande));
									...
									if (row4.numTel != null) { //
										...
										strBuffer_tLogRow_1.append(String.valueOf(row4.numTel));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final exercice01_01_V2 exercice01_01_V2Class = new exercice01_01_V2();

		int exitCode = exercice01_01_V2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice01_01_V2.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice01_01_v2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = exercice01_01_V2.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : exercice01_01_V2");
		}
...
/************************************************************************************************
 * 94242 characters generated by Talend Open Studio for Data Integration on the
 * 4 février 2023 à 20:09:01 GMT+01:00
 ************************************************************************************************/