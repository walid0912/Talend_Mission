...
package mission_talend.excercice01_05_v2_0_1;
...
/**
 * Job: excercice01_05_V2 Purpose: Affectation des candidats aux managers et aux
 * départements<br>
 ...
 * @status TEST
 */
public class excercice01_05_V2 implements TalendJob {
	...
	private final String jobName = "excercice01_05_V2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					excercice01_05_V2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excercice01_05_V2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MISSION_TALEND_excercice01_05_V2 = new byte[0];
		static byte[] commonByteArray_MISSION_TALEND_excercice01_05_V2 = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MISSION_TALEND_excercice01_05_V2) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_1 = "tHashFile_excercice01_05_V2_" + pid + "_tHashOutput_1";
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MISSION_TALEND_excercice01_05_V2.length) {
					if (length < 1024 && commonByteArray_MISSION_TALEND_excercice01_05_V2.length == 0) {
						commonByteArray_MISSION_TALEND_excercice01_05_V2 = new byte[1024];
					} else {
						commonByteArray_MISSION_TALEND_excercice01_05_V2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MISSION_TALEND_excercice01_05_V2, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_excercice01_05_V2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MISSION_TALEND_excercice01_05_V2, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_excercice01_05_V2, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_2 = "tHashFile_excercice01_05_V2_" + pid + "_tHashOutput_2";
				synchronized (org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_1 = mf_tHashInput_1
						.getAdvancedMemoryHashFile("tHashFile_excercice01_05_V2_" + pid + "_tHashOutput_1");
				...
				org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
						.remove("tHashFile_excercice01_05_V2_" + pid + "_tHashOutput_1");
...
///////////////////////    			
						...
						obj_tRunJob_1 = ((Integer) globalMap.get("row5.ManagerID"));
						if (obj_tRunJob_1 != null) {
							if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
								paraList_tRunJob_1
										.add("--context_param ManagerID=" + ((java.util.Date) obj_tRunJob_1).getTime());
							} else {
								paraList_tRunJob_1.add("--context_param ManagerID="
						...
						parentContextMap_tRunJob_1.put("ManagerID", obj_tRunJob_1);

						obj_tRunJob_1 = ((Integer) globalMap.get("row5.DepartmentID"));
						if (obj_tRunJob_1 != null) {
							if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
								paraList_tRunJob_1.add(
										"--context_param DepartmentID=" + ((java.util.Date) obj_tRunJob_1).getTime());
							} else {
								paraList_tRunJob_1.add("--context_param DepartmentID="
										+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
							}
						} else {
							paraList_tRunJob_1.add("--context_param DepartmentID="
						...
						parentContextMap_tRunJob_1.put("DepartmentID", obj_tRunJob_1);

						obj_tRunJob_1 = ((String) globalMap.get("row5.sample"));
						if (obj_tRunJob_1 != null) {
							if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
								paraList_tRunJob_1
										.add("--context_param sample=" + ((java.util.Date) obj_tRunJob_1).getTime());
							} else {
								paraList_tRunJob_1.add(
										"--context_param sample=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
							}
						} else {
							paraList_tRunJob_1.add("--context_param sample="
									+ NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
						}

						parentContextMap_tRunJob_1.put("sample", obj_tRunJob_1);

						mission_talend.exercice05_01_0_1.exercice05_01 childJob_tRunJob_1 = new mission_talend.exercice05_01_0_1.exercice05_01();
						// pass DataSources
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final excercice01_05_V2 excercice01_05_V2Class = new excercice01_05_V2();

		int exitCode = excercice01_05_V2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = excercice01_05_V2.class.getClassLoader()
					.getResourceAsStream("mission_talend/excercice01_05_v2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excercice01_05_V2.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : excercice01_05_V2");
		}
...
/************************************************************************************************
 * 147991 characters generated by Talend Open Studio for Data Integration on the
 * 9 février 2023 à 22:41:08 GMT+01:00
 ************************************************************************************************/