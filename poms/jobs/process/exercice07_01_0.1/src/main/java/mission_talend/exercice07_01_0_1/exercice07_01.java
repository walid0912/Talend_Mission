...
package mission_talend.exercice07_01_0_1;
...
/**
 * Job: exercice07_01 Purpose: Création d'un job et execution de ce dernier en externe<br>
 * Description: Créer et exporter un job <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status TEST
 */
public class exercice07_01 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "exercice07_01";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				exercice07_01.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(exercice07_01.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	currentComponent="tFileTouch_1";
		...
		java.io.File file_tFileTouch_1 = new java.io.File(("C:/Users/Abdelhak Pedro/Documents/Talend_Mission/"+TalendDate.formatDate("yyyy-MM-dd_HHmmss",new Date())));        
 ...
 */
    ...
    public static void main(String[] args){
        final exercice07_01 exercice07_01Class = new exercice07_01();

        int exitCode = exercice07_01Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = exercice07_01.class.getClassLoader().getResourceAsStream("mission_talend/exercice07_01_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = exercice07_01.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : exercice07_01");
        }
...
/************************************************************************************************
 *     26959 characters generated by Talend Open Studio for Data Integration 
 *     on the 10 février 2023 à 12:20:51 GMT+01:00
 ************************************************************************************************/