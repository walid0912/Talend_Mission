...
package mission_talend.exercice01_04_1_0;
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "hr" + "?"
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:P8hp2OZfVr90sDvuo2KRM+doLPDqj+t9DiadLh8UEm3ZgDWBqnDU");
				...
				globalMap.put("db_tDBConnection_1", "hr");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/Abdelhak Pedro/Documents/Talend_Mission/manager_optimized_a.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/Users/Abdelhak Pedro/Documents/Talend_Mission/managers_optimized.csv")).getAbsolutePath()
								.replace("\\", "/");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice01_04.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice01_04_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 148208 characters generated by Talend Open Studio for Data Integration on the
 * 10 février 2023 à 11:10:10 GMT+01:00
 ************************************************************************************************/