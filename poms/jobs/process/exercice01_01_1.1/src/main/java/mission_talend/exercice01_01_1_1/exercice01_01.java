...
package mission_talend.exercice01_01_1_1;
...
/**
 * Job: exercice01_01 Purpose: Génération des fichiers CSV<br>
 ...
 * @status TEST
 */
public class exercice01_01 implements TalendJob {
	...
	private final String jobName = "exercice01_01";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					exercice01_01.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(exercice01_01.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_MISSION_TALEND_exercice01_01 = new byte[0];
		static byte[] commonByteArray_MISSION_TALEND_exercice01_01 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MISSION_TALEND_exercice01_01.length) {
					if (length < 1024 && commonByteArray_MISSION_TALEND_exercice01_01.length == 0) {
						commonByteArray_MISSION_TALEND_exercice01_01 = new byte[1024];
					} else {
						commonByteArray_MISSION_TALEND_exercice01_01 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MISSION_TALEND_exercice01_01, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice01_01, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MISSION_TALEND_exercice01_01, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice01_01, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MISSION_TALEND_exercice01_01) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/Abdelhak Pedro/Documents/Talend_Mission/candidats_myRoutine.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				class tRowGenerator_1Randomizer {
					public String getRandomnom() {
						...
						return MyRoutine.getLastName();

					}

					public String getRandomprenom() {

						return MyRoutine.getFirstName();
	...
	public static void main(String[] args) {
		final exercice01_01 exercice01_01Class = new exercice01_01();

		int exitCode = exercice01_01Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice01_01.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice01_01_1_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = exercice01_01.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : exercice01_01");
		}
...
/************************************************************************************************
 * 45751 characters generated by Talend Open Studio for Data Integration on the
 * 8 février 2023 à 00:53:18 GMT+01:00
 ************************************************************************************************/