...
package mission_talend.exercice09_01_0_1;
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = ((String) globalMap.get("tFileOutputDelimited_1_ERROR_MESSAGE"));
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice09_01.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice09_01_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 49225 characters generated by Talend Open Studio for Data Integration on the
 * 10 février 2023 à 15:02:23 GMT+01:00
 ************************************************************************************************/