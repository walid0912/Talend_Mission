...
package mission_talend.exercice06_02_0_1;
...
/**
 * Job: exercice06_02 Purpose: Préparation des données de tests<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class exercice06_02 implements TalendJob {
	...
	private final String jobName = "exercice06_02";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					exercice06_02.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(exercice06_02.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_MISSION_TALEND_exercice06_02 = new byte[0];
		static byte[] commonByteArray_MISSION_TALEND_exercice06_02 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MISSION_TALEND_exercice06_02.length) {
					if (length < 1024 && commonByteArray_MISSION_TALEND_exercice06_02.length == 0) {
						commonByteArray_MISSION_TALEND_exercice06_02 = new byte[1024];
					} else {
						commonByteArray_MISSION_TALEND_exercice06_02 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MISSION_TALEND_exercice06_02, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice06_02, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MISSION_TALEND_exercice06_02, 0, length);
				strReturn = new String(commonByteArray_MISSION_TALEND_exercice06_02, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MISSION_TALEND_exercice06_02) {
	...
	public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_2 = "employees";
				...
				String url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "hr" + "?"
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:C5KBAG162GPkwmaBkwBVKqQoLcFjLrpLwYbEVgrYd4d7tmvWzcTx");
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "employees"
						+ "` (`EmployeeID`,`FirstName`,`LastName`,`Email`,`PhoneNumber`,`HireDate`,`JobCode`,`Salary`,`CommissionPercentage`,`ManagerID`,`DepartmentID`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				String properties_tDBRow_1 = "noDatetimeStringSync=true&enabledTLSProtocols=TLSv1.2,TLSv1.1,TLSv1";
				...
				String url_tDBRow_1 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "hr" + "?"
						+ properties_tDBRow_1;
				String dbUser_tDBRow_1 = "talend";

				final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:G3FwxDZB/3lLGMbKNxSrI2rHRZiYGoXw2lh8SAeMgp9UEPIFYb5a");
				...
				query_tDBRow_1 = "CREATE INDEX DepartmentID ON employees (DepartmentID)";
...
// Start of branch "row2"
				if (row2 != null) {
					...
					if (row2.EmployeeID == null) {
						...
						pstmt_tDBOutput_2.setInt(1, row2.EmployeeID);
					}

					if (row2.FirstName == null) {
						pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(2, row2.FirstName);
					}

					if (row2.LastName == null) {
						pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(3, row2.LastName);
					}

					if (row2.Email == null) {
						pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(4, row2.Email);
					}

					if (row2.PhoneNumber == null) {
						pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(5, row2.PhoneNumber);
					}

					if (row2.HireDate != null) {
						date_tDBOutput_2 = row2.HireDate.getTime();
						if (date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
							...
							pstmt_tDBOutput_2.setTimestamp(6, new java.sql.Timestamp(date_tDBOutput_2));
						}
					} else {
						pstmt_tDBOutput_2.setNull(6, java.sql.Types.DATE);
					}

					if (row2.JobCode == null) {
						pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(7, row2.JobCode);
					}

					if (row2.Salary == null) {
						pstmt_tDBOutput_2.setNull(8, java.sql.Types.DOUBLE);
					} else {
						pstmt_tDBOutput_2.setDouble(8, row2.Salary);
					}

					if (row2.CommissionPercentage == null) {
						pstmt_tDBOutput_2.setNull(9, java.sql.Types.DOUBLE);
					} else {
						pstmt_tDBOutput_2.setDouble(9, row2.CommissionPercentage);
					}

					if (row2.ManagerID == null) {
						pstmt_tDBOutput_2.setNull(10, java.sql.Types.INTEGER);
					} else {
						pstmt_tDBOutput_2.setInt(10, row2.ManagerID);
					}

					if (row2.DepartmentID == null) {
						pstmt_tDBOutput_2.setNull(11, java.sql.Types.INTEGER);
					} else {
						pstmt_tDBOutput_2.setInt(11, row2.DepartmentID);
					}
	...
	public static void main(String[] args) {
		final exercice06_02 exercice06_02Class = new exercice06_02();

		int exitCode = exercice06_02Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = exercice06_02.class.getClassLoader()
					.getResourceAsStream("mission_talend/exercice06_02_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = exercice06_02.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : exercice06_02");
		}
...
/************************************************************************************************
 * 56565 characters generated by Talend Open Studio for Data Integration on the
 * 10 février 2023 à 12:09:42 GMT+01:00
 ************************************************************************************************/